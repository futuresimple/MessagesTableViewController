...
+ (CGSize)textSizeForText:(NSString *)txt
{
    CGFloat factor = [[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone ? 0.7f : 0.5f;
    CGFloat maxWidth = [UIScreen mainScreen].applicationFrame.size.width * factor;
